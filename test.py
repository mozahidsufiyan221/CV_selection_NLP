...
def create_profile(file):
    ...
    keyword_dict = pd.read_csv('C:\\a_work\\a_iot\\CV_selection_NLP\\skill_set.csv')
    ...
    PM_words = [nlp(text) for text in keyword_dict['PM'].dropna(axis=0)]
    BI_words = [nlp(text) for text in keyword_dict['BI'].dropna(axis=0)]
